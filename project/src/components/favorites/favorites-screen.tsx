...
import { MockOffer } from "../../types/offer"
...
function FavoriteOffer ({favoriteOffer}: FavoriteScreenProps): JSX.Element {
    return (
        ...
        <div className="favorites__card-info place-card__info">
          ...
          <Link to={generatePath(AppRoute.Room, {id: `${favoriteOffer.id}`})}>{favoriteOffer.title}</Link>
          </h2>
